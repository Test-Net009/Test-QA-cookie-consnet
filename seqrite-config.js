...
window.klaroConfig = {
  "consentManagerId": "6a2930ef5a96fb4cea9bc19d",
  "uuid": "026a318c-0e7c-4e59-b37e-1759d2532afe",
  "domain": "https://perf.pre-dataprivacy.com/cmapi",
  "version": 1,
  "elementID": "SEQRITE",
  lang: userLang,
  "storageMethod": "cookie",
  "storageName": "https://boluat.sudlife.in/",
  ...
  "translations": {
    ...
    "doi": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "वैबसाइट दे ठीक चाल्ली कन्नै कम्म करने आस्तै लाजमी कुकीज़ लाजमी न। ओह् सुरक्षा, नौपरिवहन ते उपयोगकर्ता सत्र प्रबंधन जनेही मूल विशेशताएं दा समर्थन करदे न।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "ml": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "വെബ്സൈറ്റിന്റെ ശരിയായ പ്രവർത്തനത്തിന് ആവശ്യമായ കുക്കികൾ അത്യാവശ്യമാണ്. സുരക്ഷ, നാവിഗേഷൻ, ഉപയോക്തൃ സെഷൻ മാനേജ്മെന്റ് തുടങ്ങിയ പ്രധാന സവിശേഷതകളെ അവ പിന്തുണയ്ക്കുന്നു.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "mni": {
      ...
      "ok": "ꯄꯨꯝꯅꯃꯛ ꯂꯧꯕꯤꯌꯨ",
      "consentNotice": {
        "description": "ꯑꯩꯈꯣꯏꯅ ꯅꯍꯥꯛꯀꯤ ꯂꯟꯅꯥꯏꯕꯨ ꯏꯀꯥꯏ ꯈꯨꯝꯅꯩ ꯑꯩꯈꯣꯏꯅ ꯇꯉꯥꯏꯐꯗꯕ ꯁꯥꯏꯠ ꯃꯊꯧ ꯇꯧꯕ ꯉꯝꯕ, ꯃꯥꯔꯀꯦꯇꯤꯡ, ꯄꯦꯁ ꯭ ꯅꯦꯜꯥꯏꯖꯦꯁꯟ ꯑꯃꯁꯨꯡ ꯑꯦꯅꯥꯂꯤꯇꯤꯛꯁ ꯇꯧꯕ ꯉꯝꯅꯕ ꯀꯨꯀꯤꯁꯤꯡ ꯊꯝꯃꯤ ꯫ \"ꯄꯨꯝꯅꯃꯛ ꯌꯥꯕꯤꯌꯨ\" ꯍꯥꯏꯕ ꯑꯗꯨꯗ ꯅꯝꯗꯨꯅ, ꯅꯍꯥꯛꯅ ꯑꯩꯈꯣꯏꯒꯤ ꯀꯨꯀꯤꯁꯤꯡ ꯁꯤꯖꯤꯟꯅꯕ ꯌꯥꯔꯦ ꯫ ꯅꯍꯥꯛꯅ ꯃꯇꯝ ꯑꯃꯍꯦꯛꯇꯗ ꯅꯍꯥꯛꯀꯤ ꯁꯦꯇꯤꯡꯁ ꯑꯗꯨ ꯍꯣꯡꯗꯣꯛꯄ ꯌꯥꯏ ꯫ ꯀꯨꯀꯤꯒꯤ ꯊꯧꯁꯤꯜ ꯫",
      ...
      "necessary": {
        "title": "Necessary",
        "description": "ꯋꯦꯕꯁꯥꯏꯠ ꯑꯗꯨ ꯐꯖꯅ ꯊꯕꯛ ꯇꯧꯅꯕꯒꯤꯗꯃꯛ ꯃꯊꯧ ꯇꯥꯕ ꯀꯨꯀꯤꯁꯤꯡ ꯑꯁꯤ ꯇꯉꯥꯏꯐꯗꯦ ꯫ ꯃꯈꯣꯏꯅ ꯁꯦꯀ ꯭ ꯌꯨꯔꯤꯇꯤ, ꯅꯦꯚꯤꯒꯦꯁꯟ, ꯑꯃꯁꯨꯡ ꯌꯨꯖꯔ ꯁꯦꯁꯟ ꯃꯦꯅꯖꯃꯦꯟꯠꯒꯨꯝꯕ ꯃꯔꯨꯑꯣꯏꯕ ꯐꯤꯆꯔꯁꯤꯡꯕꯨ ꯁꯧꯒꯠꯂꯤ ꯫<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "sat": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "ᱳᱭᱮᱵᱥᱟᱭᱤᱴ ᱨᱮᱭᱟᱜ ᱱᱟᱯᱟᱭ ᱠᱟᱹᱢᱤ ᱞᱟᱹᱜᱤᱫ ᱞᱟᱹᱠᱛᱤ ᱟᱱᱟᱜ ᱠᱩᱠᱤ ᱠᱚᱫᱚ ᱞᱟᱹᱠᱛᱤ ᱠᱟᱱᱟ ᱾ ᱱᱚᱶᱟ ᱠᱚᱫᱚ ᱨᱩᱠᱷᱟᱹᱭᱤ, ᱱᱟᱵᱷᱤᱜᱮᱥᱚᱱ ᱟᱨ ᱵᱮᱶᱦᱟᱨᱤᱭᱟᱹ ᱥᱮᱥᱚᱱ ᱵᱚᱱᱫᱮᱡ ᱞᱮᱠᱟᱱ ᱢᱩᱲᱩᱫ ᱩᱨᱜᱟᱹᱱ ᱠᱚ ᱮᱥᱮᱨ ᱞᱮᱫᱟ ᱾<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "ur": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "ویب سائٹ کے مناسب کام کے لیے ضروری کوکیز ضروری ہیں۔ وہ سیکیورٹی، نیویگیشن، اور صارف سیشن مینجمنٹ جیسی بنیادی خصوصیات کی حمایت کرتے ہیں۔<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "brx": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "अवेबसाइटआ मोजाङै खामानि मावनो थाखाय गोनां कुकिसनि गोनांथि जायो। बिसोरो रैखाथि, नेभिगेसन आरो बाहायगिरिनि सेसन सामलायथि बायदि गुदि आखुथायफोरखौ हेफाजाब होयो।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "mr": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "संकेतस्थळाच्या योग्य कार्यासाठी आवश्यक कुकीज आवश्यक आहेत. ते सुरक्षा, नेव्हिगेशन आणि वापरकर्ता सत्र व्यवस्थापन यासारख्या मुख्य वैशिष्ट्यांना समर्थन देतात.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "or": {
      ...
      "consentNotice": {
        "description": "ଆମେ ଆପଣଙ୍କ ଗୋପନୀୟତାକୁ ସମ୍ମାନ କରୁ, ଆମେ ଅତ୍ୟାବଶ୍ୟକ ସାଇଟ୍ କାର୍ଯ୍ୟକାରିତା ତଥା ବିପଣନ, ବ୍ୟକ୍ତିଗତକରଣ ଏବଂ ବିଶ୍ଳେଷଣକୁ ସକ୍ଷମ କରିବା ପାଇଁ କୁକିଜ୍ ଷ୍ଟୋର୍ କରୁ। \"ସମସ୍ତଙ୍କୁ ଗ୍ରହଣ କରନ୍ତୁ\" ଉପରେ କ୍ଲିକ୍ କରି, ଆପଣ ଆମର କୁକିଜ୍ ବ୍ୟବହାର ପାଇଁ ରାଜି ହୁଅନ୍ତି। ଆପଣ ଯେକୌଣସି ସମୟରେ ନିଜର ସେଟିଂ ବଦଳାଇ ପାରିବେ। କୁକି ନୀତି।",
      ...
      "necessary": {
        "title": "Necessary",
        "description": "ୱେବସାଇଟର ସଠିକ୍ କାର୍ଯ୍ୟକାରିତା ପାଇଁ ଆବଶ୍ୟକ କୁକିଜ୍ ଆବଶ୍ୟକ | ସେମାନେ ସୁରକ୍ଷା, ନେଭିଗେସନ୍ ଏବଂ ୟୁଜର୍ ସେସନ୍ ମ୍ୟାନେଜମେଣ୍ଟ ପରି ମୁଖ୍ୟ ବୈଶିଷ୍ଟ୍ୟଗୁଡ଼ିକୁ ସମର୍ଥନ କରନ୍ତି |<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "as": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "ৱেবছাইটটো সঠিকভাৱে কাম কৰাৰ বাবে প্ৰয়োজনীয় কুকিজ অত্যাৱশ্যকীয়। এইবোৰে সুৰক্ষা, নেভিগেচন, আৰু ব্যৱহাৰকাৰী অধিবেশন ব্যৱস্থাপনাৰ দৰে মূল বৈশিষ্ট্যসমূহক সমৰ্থন কৰে।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "mai": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "वेबसाइटक उचित कार्यक लेल आवश्यक कुकीज आवश्यक अछि। ओ सुरक्षा, नेविगेशन, आ उपयोगकर्ता सत्र प्रबंधन सन मुख्य सुविधासभक समर्थन करैत अछि।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
      ...
      "analytics": {
        "title": "Analytics",
        "description": "ई कुकीज वेबसाइट ट्रैफिक, उपयोगकर्ता व्यवहार, आ संलग्नता पैटर्न के विश्लेषण करै मे हमर मदद करैत अछि। एकत्रित अंतर्दृष्टि हमरा सभकेँ सामग्रीकेँ अनुकूलित करबाक, उपयोगिताकेँ बढ़यबाक, आ समग्र साइट प्रदर्शनमे सुधार करबाक अनुमति दैत अछि।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">3 Cookies</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_ga</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Google Analytics</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_ga_PVJW50VW89</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Google Analytics</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_ga_YCWZE3RK98</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Google Analytics</div></div></div></details>"
      },
      "marketing": {
        "title": "Marketing",
    ...
    "ta": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "வலைத்தளத்தின் சரியான செயல்பாட்டிற்கு தேவையான குக்கீகள் அவசியம். பாதுகாப்பு, வழிசெலுத்தல் மற்றும் பயனர் அமர்வு மேலாண்மை போன்ற முக்கிய அம்சங்களை அவை ஆதரிக்கின்றன.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "sd": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "ویب سائیٽ جی صحیح ڪم ڪرڻ لاء ضروری ڪوڪی ضروری آھن اھی بنیادی فیچرز کی سپورٽ ڪن ٿا جہڙوڪ سیڪیورٽی نیویگیشن ۽ یوزر سیشن مئنیجمینٽ<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "bn": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "ওয়েবসাইটের সঠিক কার্যকারিতার জন্য প্রয়োজনীয় কুকিজ অপরিহার্য। এগুলি নিরাপত্তা, নেভিগেশন এবং ব্যবহারকারীর অধিবেশন পরিচালনার মতো মূল বৈশিষ্ট্যগুলিকে সমর্থন করে।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "te": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "వెబ్సైట్ సరిగ్గా పనిచేయడానికి అవసరమైన కుకీలు అవసరం. అవి భద్రత, నావిగేషన్ మరియు యూజర్ సెషన్ మేనేజ్మెంట్ వంటి ప్రధాన లక్షణాలకు మద్దతు ఇస్తాయి.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
        "description": "వెబ్సైట్ కార్యాచరణను మెరుగుపరచడానికి మరియు వినియోగదారు అనుభవాన్ని మెరుగుపరచడానికి మేము ఈ కుకీలను ఉపయోగిస్తాము. సమాచారంలో లాగిన్ డేటా, ప్రాంతం, భాష మరియు మెరుగైన కంటెంట్ ఉండవచ్చు.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">4 Cookies</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;ASP.NET_SessionId</div><div><b>Host:</b>&nbsp;boluat.sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;__RequestVerificationToken</div><div><b>Host:</b>&nbsp;boluat.sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;ak_bmsc</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_sv</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div></div></details>"
      },
      "analytics": {
        "title": "Analytics",
    ...
    "kn": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "ವೆಬ್ಸೈಟ್ನ ಸರಿಯಾದ ಕಾರ್ಯನಿರ್ವಹಣೆಗೆ ಅಗತ್ಯವಾದ ಕುಕೀಗಳು ಅತ್ಯಗತ್ಯ. ಅವು ಭದ್ರತೆ, ಸಂಚರಣೆ ಮತ್ತು ಬಳಕೆದಾರರ ಅಧಿವೇಶನ ನಿರ್ವಹಣೆಯಂತಹ ಪ್ರಮುಖ ವೈಶಿಷ್ಟ್ಯಗಳನ್ನು ಬೆಂಬಲಿಸುತ್ತವೆ.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "gu": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "વેબસાઇટની યોગ્ય કામગીરી માટે જરૂરી કૂકીઝ આવશ્યક છે. તેઓ સુરક્ષા, નેવિગેશન અને વપરાશકર્તા સત્ર વ્યવસ્થાપન જેવી મુખ્ય સુવિધાઓને ટેકો આપે છે.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "ne": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "वेबसाइटको उचित कार्यका लागि आवश्यक कुकीहरू आवश्यक छन्। तिनीहरूले सुरक्षा, नेभिगेसन, र प्रयोगकर्ता सत्र व्यवस्थापन जस्ता मुख्य सुविधाहरू समर्थन गर्छन्।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "hi": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "वेबसाइट के उचित संचालन के लिए आवश्यक कुकीज़ आवश्यक हैं। वे सुरक्षा, नेविगेशन और उपयोगकर्ता सत्र प्रबंधन जैसी मुख्य विशेषताओं का समर्थन करते हैं।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "gom": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "संकेतथळाचें योग्य रितीन काम करपा खातीर गरजेच्यो कुकीज गरजेच्यो आसतात. सुरक्षा, नेव्हिगेशन, आनी वापरपी सत्र वेवस्थापन ह्या सारक्या मुखेल वैशिष्ठ्यांक ते आदार दितात.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "sa": {
      ...
      "consentModal": {
        ...
        "description": "वयं कुकीस् इत्येतान् भवतां पृष्ठानां मध्ये दक्षतया मार्गनिर्देशयितुं, भवतः प्राथमिकतां सञ्चारं कर्तुं, सामान्यतया भवतः जालपुटानुभवं वर्धयितुं च उपयुज्यामः। तथापि, वयं भवतः गोपनीयतायाः अधिकारम् अङ्गीकृष्यामः, अतः भवान् केषुचित् प्रकाराणां कुकीस्-विशेषाणां अनुमतिं न दातुं चिनुयात्। विभिन्नवर्गस्य शीर्षकेषु क्लिक् कुर्वन्तु, येन अधिकं ज्ञातुं, अस्मैः पूर्वनिर्धारितानि सेट्टिङ्ग्स् च परिवर्तयितुं शक्नुयात्। कृपया लक्षयतु यत् कतिपयप्रकाराणां कुकीस् इत्येतान् अवरुद्धं कुर्वन् भवतः जालपुटस्य अनुभवः प्रभावितः भवेत्।",
        "buttons": {
          "save": "स्वीकरोतु",
          "acceptAll": "सर्वं स्वीकरोतु",
          "decline": "सर्वं निराकरोतु"
      ...
      "necessary": {
        "title": "Necessary",
        "description": "जालपुटस्य समुचितकार्यार्थम् आवश्यकानि कुकीस् आवश्यकानि सन्ति। ते सुरक्षां, मार्गनिर्देशनं, उपयोक्तृ-सत्र-प्रबन्धनम् इत्यादीनां मूलविशेषाणां समर्थनं कुर्वन्ति।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
    ...
    "it": {
      ...
      "ok": "Accetta tutto",
      "consentNotice": {
        "description": "Rispettiamo la tua privacy. Utilizziamo i cookie per abilitare le funzionalità essenziali del sito, nonché per scopi di marketing, personalizzazione e analisi. Cliccando su &quot;Accetta tutto&quot;, acconsenti al nostro utilizzo dei cookie. Puoi modificare le tue impostazioni in qualsiasi momento. Informativa sui cookie.",
      ...
      "consentModal": {
        ...
        "description": "Utilizziamo i cookie per facilitare la navigazione tra le pagine, memorizzare le tue preferenze e, in generale, migliorare la tua esperienza sul sito web. Tuttavia, riconosciamo il tuo diritto alla privacy e pertanto puoi scegliere di non consentire alcuni tipi di cookie. Clicca sulle diverse intestazioni di categoria per saperne di più e modificare le nostre impostazioni predefinite. Tieni presente che il blocco di alcuni tipi di cookie potrebbe influire sulla tua esperienza di navigazione sul sito.",
        "buttons": {
          "save": "Accettare",
          "acceptAll": "Accetta tutto",
          "decline": "Rifiuta tutto"
      ...
      "necessary": {
        "title": "Necessary",
        "description": "I cookie necessari sono essenziali per il corretto funzionamento del sito web. Supportano funzionalità fondamentali come la sicurezza, la navigazione e la gestione della sessione utente.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
        "description": "Utilizziamo questi cookie per migliorare le funzionalità del sito web e l&#39;esperienza utente. Le informazioni possono includere dati di accesso, regione, lingua e contenuti personalizzati.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">4 Cookies</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;ASP.NET_SessionId</div><div><b>Host:</b>&nbsp;boluat.sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;__RequestVerificationToken</div><div><b>Host:</b>&nbsp;boluat.sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;ak_bmsc</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_sv</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div></div></details>"
      },
      "analytics": {
        "title": "Analytics",
        "description": "Questi cookie ci aiutano ad analizzare il traffico del sito web, il comportamento degli utenti e i modelli di interazione. Le informazioni raccolte ci consentono di ottimizzare i contenuti, migliorare l&#39;usabilità e ottimizzare le prestazioni complessive del sito.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">3 Cookies</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_ga</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Google Analytics</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_ga_PVJW50VW89</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Google Analytics</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_ga_YCWZE3RK98</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Google Analytics</div></div></div></details>"
      },
      "marketing": {
        "title": "Marketing",
        "description": "Questi cookie vengono utilizzati dai nostri partner pubblicitari per fornire annunci personalizzati e misurare l&#39;efficacia delle campagne di marketing. Contribuiscono a fornire promozioni pertinenti in base agli interessi dell&#39;utente e al suo comportamento di navigazione.<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_gcl_au</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Google Ads</div></div></div></details>"
      }
    },
    "pa": {
      ...
      "necessary": {
        "title": "Necessary",
        "description": "ਵੈੱਬਸਾਈਟ ਦੇ ਸਹੀ ਕੰਮਕਾਜ ਲਈ ਜ਼ਰੂਰੀ ਕੂਕੀਜ਼ ਜ਼ਰੂਰੀ ਹਨ। ਇਹ ਸੁਰੱਖਿਆ, ਨੈਵੀਗੇਸ਼ਨ ਅਤੇ ਉਪਭੋਗਤਾ ਸੈਸ਼ਨ ਪ੍ਰਬੰਧਨ ਵਰਗੀਆਂ ਮੁੱਖ ਵਿਸ਼ੇਸ਼ਤਾਵਾਂ ਦਾ ਸਮਰਥਨ ਕਰਦੀਆਂ ਹਨ।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_mi</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Other Cookies</div></div></div></details>"
      },
      "functional": {
        "title": "Functional",
        "description": "ਅਸੀਂ ਇਹਨਾਂ ਕੂਕੀਜ਼ ਦੀ ਵਰਤੋਂ ਵੈੱਬਸਾਈਟ ਦੀ ਕਾਰਜਸ਼ੀਲਤਾ ਨੂੰ ਵਧਾਉਣ ਅਤੇ ਉਪਭੋਗਤਾ ਅਨੁਭਵ ਨੂੰ ਬਿਹਤਰ ਬਣਾਉਣ ਲਈ ਕਰਦੇ ਹਾਂ। ਜਾਣਕਾਰੀ ਵਿੱਚ ਲੌਗਇਨ ਡੇਟਾ, ਖੇਤਰ, ਭਾਸ਼ਾ ਅਤੇ ਵਧੀ ਹੋਈ ਸਮੱਗਰੀ ਸ਼ਾਮਲ ਹੋ ਸਕਦੀ ਹੈ।<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">4 Cookies</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;ASP.NET_SessionId</div><div><b>Host:</b>&nbsp;boluat.sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;__RequestVerificationToken</div><div><b>Host:</b>&nbsp;boluat.sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;ak_bmsc</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;bm_sv</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Functional Cookies</div></div></div></details>"
      },
      "analytics": {
        "title": "Analytics",
