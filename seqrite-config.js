...
window.klaroConfig = {
  "consentManagerId": "6a3d29f44ca50a30a4324c44",
  "uuid": "f29a6521-26fe-48d1-8e3c-059fb7878924",
  "domain": "https://starhealth.pre-dataprivacy.com/cmapi",
  "version": 1,
  "elementID": "SEQRITE",
  lang: userLang,
  "storageMethod": "cookie",
  "storageName": "boluat_sudlife_in_",
  ...
  "translations": {
    ...
    "ks": {
      ...
      "marketing": {
        "title": "Marketing",
        "description": "یم کوکیز چھ سٲنۍ تشہیری شراکت دار ذاتی اشتہار فراہم کرنہٕ تہٕ مارکیٹنگ مہمن ہنٛد اثر و رسوخچ پیمٲئش کرنہٕ خٲطرٕ استعمال کران۔ تم چھ صارفن ہنٛز دلچسپین تہٕ براؤزنگ رویس پیٹھ مبنی متعلقہ پروموشنز فراہم کرنس منٛز مدد کران۔<details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_gcl_au</div><div><b>Host:</b>&nbsp;sudlife.in</div><div><b>Service:</b>&nbsp;Google Ads</div></div></div></details>"
      },
      "others": {
        "title": "Others",
